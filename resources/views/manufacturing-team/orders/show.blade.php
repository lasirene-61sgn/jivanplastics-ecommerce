                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>Manufactured (Pieces)</th>
                            <th>Rejected (Pieces)</th>
                            <th>Pending (Pieces)</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($order->items as $item)
                            <tr>
                                ...
                                <td>{{ $item->total_pieces }} pcs</td>
                                <td style="color: #28a745; font-weight: 700;">{{ $item->manufactured_pieces }} pcs</td>
                                <td style="color: #dc3545;">{{ $item->rejected_pieces }} pcs</td>
                                <td>
                                ...
                                <div class="form-group" style="background: #fdfdfd; padding: 15px; border-radius: 10px; border: 1px solid #eee; margin-bottom: 15px;">
                                    <label style="display: block; font-weight: 700; color: #333; margin-bottom: 8px;">
                                        ...
                                        <span style="color: #666; font-weight: normal; float: right;">
                                            Pending: <strong>{{ $item->manufacturing_pending_pieces }} pieces</strong>
                                        </span>
                                    </label>
